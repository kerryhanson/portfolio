export const profile = {
  ...
  phone: '612.280.5320',
  linkedin: 'https://www.linkedin.com/in/kerry-hanson-0a975547/',
...
Passionate about modernizing UX practices through AI-enabled workflows that accelerate research, prototyping, and design validation while maintaining a strong focus on accessibility, usability, and measurable business outcomes.`,
  ...
  strengths: [
    ...
    {
      category: 'Research & Experience Design',
      items: [
        'User Research',
        'Usability Testing',
    ...
    {
      category: 'Design Systems & Product Delivery',
      items: [
        'Design Systems',
        'UX Analysis',
        'Product Strategy',
  ...
  experience: [
      ...
      roles: [
        {
          ...
          highlights: [
            ...
            'Led the evolution of the Canvas design system used across Strayer, Capella, and JWMI, trained 30+ learning technologists.',
    ...
    {
      company: 'Colder Products Company (CPC)',
      ...
      roles: [
        {
          ...
          highlights: [
            ...
            'Maintained brand consistency across digital and print deliverables.',
    ...
    {
      company: 'Drebenstedt Consulting',
      location: 'St. Paul, MN',
      roles: [
        {
          title: 'UI Designer',
    ...
    {
      company: 'Accurate Image Marketing',
      location: 'Minneapolis, MN',
      roles: [
        {
  ...
  education: [
    {
      ...
      location: 'Minneapolis, MN',
      degree: 'Associate of Applied Science, Multimedia/Graphic Design',
      period: '1996 – 1998',
    },
  ],
}
